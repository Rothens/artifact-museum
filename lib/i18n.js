...
export const DEFAULT_LOCALE = SUPPORTED_LOCALES.includes(envLocale) ? envLocale : "hu";
...
const translations = {
  en: {
    ...
    // Admin – edit item – trip assignment
    "admin.edit.trip": "Trip assignment",
    "admin.edit.trip.auto": "Auto (by date)",
    "admin.edit.trip.none": "No trip",
    "admin.edit.trip.resolved": "Currently assigned:",

    // Admin – trips CRUD
    "admin.trips.title": "Trips",
    "admin.trips.new": "New trip",
    "admin.trips.name": "Name",
    "admin.trips.description": "Description",
    "admin.trips.date_start": "Start date",
    "admin.trips.date_end": "End date",
    "admin.trips.items": "Items",
    "admin.trips.public": "Public",
    "admin.trips.edit": "Edit",
    "admin.trips.save": "Save",
    "admin.trips.delete": "Delete trip",
    "admin.trips.delete.confirm": "Delete this trip? Items will not be deleted.",
    "admin.trips.empty": "No trips yet.",

    // Public trip page
    "trip.dates": "Dates",
    "trip.items_on_map": "Items on the map",
    "trip.items_no_coords": "Also collected on this trip",
    "trip.unnamed": "Unnamed trip",
    "trip.timeline": "Timeline",
    "trip.timeline.play": "Play",
    "trip.timeline.pause": "Pause",
    "trip.back": "Back",
  ...
  hu: {
    ...
    // Admin – edit item – trip assignment
    "admin.edit.trip": "Út hozzárendelés",
    "admin.edit.trip.auto": "Automatikus (dátum alapján)",
    "admin.edit.trip.none": "Nincs út",
    "admin.edit.trip.resolved": "Jelenleg hozzárendelve:",

    // Admin – trips CRUD
    "admin.trips.title": "Utak",
    "admin.trips.new": "Új út",
    "admin.trips.name": "Név",
    "admin.trips.description": "Leírás",
    "admin.trips.date_start": "Kezdő dátum",
    "admin.trips.date_end": "Záró dátum",
    "admin.trips.items": "Tárgyak",
    "admin.trips.public": "Nyilvános",
    "admin.trips.edit": "Szerkesztés",
    "admin.trips.save": "Mentés",
    "admin.trips.delete": "Út törlése",
    "admin.trips.delete.confirm": "Törli ezt az utat? A tárgyak nem törlődnek.",
    "admin.trips.empty": "Még nincs út.",

    // Public trip page
    "trip.dates": "Időszak",
    "trip.items_on_map": "Tárgyak a térképen",
    "trip.items_no_coords": "Szintén ezen az úton gyűjtve",
    "trip.unnamed": "Névtelen út",
    "trip.timeline": "Idővonal",
    "trip.timeline.play": "Lejátszás",
    "trip.timeline.pause": "Szünet",
    "trip.back": "Vissza",
